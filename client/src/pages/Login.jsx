          ...
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center mt-4">
              <button
                type="submit"
                onClick={create}
                className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-black rounded-md hover:bg-purple-800 focus:outline-none focus:bg-gray-600"
              >
                Register
              </button>
            </div>
